...
namespace FarseerPhysics.Collision
{
    ...
    {
        /// <summary>
        /// The ray extends from x to x + maxFraction * (y - x).
        /// If you supply a max fraction of 1, the ray extends from x to y.
        /// A max fraction of 0.5 makes the ray go from x and half way to y.
        /// </summary>
    ...
    {
        /// <summary>
        /// The ray hits at x + fraction * (y - x), where x and y come from RayCastInput.
